...
const projects: Project[] = [
  {
    title: "Stoic Stack",
    description:
      "A MindOS beta that builds empowerment, productivity, and mental health that AI can't replace in a developer's life.",
  ...
  },
  {
    ...
    description:
      "A blog about Stoic philosophy and how it can be applied to daily life.",
  ...
  },
  {
    ...
    description:
      "A hobby project replicating the YouTube homepage. Created in HTML, CSS, and JavaScript to showcase front-end skills.",
